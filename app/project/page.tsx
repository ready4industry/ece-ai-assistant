...
export default function ProjectPage() {
  ...
  return (
    <div className="flex flex-col h-screen bg-[#f8faf7] font-sans">
      <Topbar title="Project Assistant & Architecture Advisor" />
        ...
        <main className="flex-1 flex flex-col overflow-hidden p-4 md:p-6 gap-4 max-w-5xl mx-auto w-full">
          ...
          <div className="bg-surface-container-lowest border border-primary/15 p-4 rounded-2xl shadow-[0px_4px_20px_rgba(0,83,68,0.06)] flex items-center justify-between flex-wrap gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-primary">Capstone & Embedded Project Advisor</h1>
                <p className="text-xs text-on-surface-variant">BOM validation, circuit schematics, and component selection</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
            ...
            {messages.length === 0 && (
              <div className="flex flex-col items-center justify-center h-full gap-4 text-center px-8 py-12">
                ...
                <div className="space-y-1 max-w-md">
                  <h2 className="text-xl font-bold text-primary">Project & Hardware Intelligence</h2>
                  <p className="text-xs text-on-surface-variant leading-relaxed">
                    Get assistance with component selection, sensor interface schematics, PCB layout guidelines, or micro-controller pinout constraints.
                  </p>
                </div>
              </div>
            )}
          ...
          <QueryInput value={query} onChange={setQuery} onSubmit={send} loading={loading} placeholder="Describe your project idea, target microcontroller, or BOM question..." />
        </main>
      </div>
    </div>
  );
