      ...
      <div className="w-full max-w-sm mx-4">
        <div className="stitch-card p-8">
          ...
          <button
            ...
            className="stitch-focus w-full flex items-center justify-center gap-3 rounded-md border border-primary/20 px-4 py-3 text-sm font-semibold text-on-surface transition-colors hover:bg-surface-container"
          >
