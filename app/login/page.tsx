    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#f8faf7] via-[#f2f4f1] to-[#cde8de] p-4 md:p-8 font-sans text-on-surface">
      <div className="w-full max-w-md bg-surface-container-lowest rounded-3xl p-6 md:p-8 shadow-[0px_4px_20px_rgba(0,83,68,0.08)] border border-primary/15 relative overflow-hidden">
        ...
        <div className="flex flex-col items-center text-center space-y-6 pt-2">
          ...
          {authError && (
            <div className="w-full bg-error-container text-on-error-container text-xs p-3 rounded-xl border border-error/20 text-left">
          ...
          <div className="w-full pt-2">
            <button
              ...
              disabled={signingIn}
              className="w-full flex items-center justify-center gap-3 bg-[#41FDA8] hover:bg-[#20e990] text-[#003a2f] font-semibold py-3.5 px-6 rounded-xl transition-all border border-primary/10 shadow-sm focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 text-sm disabled:opacity-50"
            >
              {signingIn ? (
                <div className="w-5 h-5 border-2 border-[#003a2f] border-t-transparent rounded-full animate-spin" />
              ) : (
